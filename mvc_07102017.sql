...
--
-- Хост: 127.0.0.1
-- Час створення: Жов 07 2017 р., 16:14
-- Версія сервера: 5.5.57-0ubuntu0.14.04.1
-- Версія PHP: 5.5.9-1ubuntu4.22
...
INSERT INTO `feedback` (`id`, `email`, `message`, `created`) VALUES
(1, 'webscript2010@gmail.com', 'sfsdfsd', '2017-09-29 17:45:20'),
(2, 'second@email.com', 'Second message', '2017-09-29 17:45:41'),
(3, 'd.kotenko@i.ua', 'dasdasdda', '2017-10-06 16:03:22'),
(4, 'sdfsd2Q@SFSDF', 'HELLO', '2017-10-06 16:30:37');
...
INSERT INTO `user` (`id`, `email`, `password`, `name`, `role`, `active`, `activation_code`) VALUES
(1, 'admin@mvc.com', '$2y$10$BxQrIjZbAUGarc8D/VBA3.2/dNr8C/csq/0f8cwVel49yrYmhrgoK', 'Admin MVC', 'ROLE_ADMIN', 1, NULL),
(2, 'user@mvc.com', '$2y$10$pn0UhyWG0lrIvv8QGQNysupcFmUB3AcO4OW95POJQxSvJSec3Yy8u', 'User MVC', 'ROLE_USER', 1, NULL);
